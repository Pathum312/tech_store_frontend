...
<nav class="navbar">
	<ul class="nav-list">
		<li class="logo">
			<button class="nav-icon" aria-controls="primary-navigation" aria-expanded="false">
				<svg class="hamburger" viewBox="0 0 100 100" width="250">
					<rect class="line top" width="80" height="10" x="10" y="25" rx="5" fill="currentColor">
					</rect>
					<rect class="line middle" width="80" height="10" x="10" y="45" rx="5" fill="currentColor">
					</rect>
					<rect class="line bottom" width="80" height="10" x="10" y="65" rx="5" fill="currentColor">
					</rect>
				</svg>
			</button>
		</li>
